/**
 * EmployeeSoapPortBindingStub.java
 *
...
public class EmployeeSoapPortBindingStub extends org.apache.axis.client.Stub implements mx.com.proyecti.EmployeeSoap {
    ...
    private static void _initOperationDesc1(){
        ...
        param.setOmittable(true);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://proyecti.com.mx/", "employee"));
        oper.setReturnClass(mx.com.proyecti.Employee.class);
    ...
    public EmployeeSoapPortBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public EmployeeSoapPortBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public EmployeeSoapPortBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://proyecti.com.mx/", "employee");
            cachedSerQNames.add(qName);
            cls = mx.com.proyecti.Employee.class;
    ...
    public mx.com.proyecti.Employee update(int id, java.lang.String firstname, java.lang.String lastname, java.util.Calendar birthdate, double salary, java.lang.String username, java.lang.String password) throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://proyecti.com.mx/", "update"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Integer(id), firstname, lastname, birthdate, new java.lang.Double(salary), username, password});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (mx.com.proyecti.Employee) _resp;
            } catch (java.lang.Exception _exception) {
                return (mx.com.proyecti.Employee) org.apache.axis.utils.JavaUtils.convert(_resp, mx.com.proyecti.Employee.class);
            }
        }
  ...
  throw axisFaultException;
    ...
    public void delete(int id) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://proyecti.com.mx/", "delete"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Integer(id)});
  ...
  throw axisFaultException;
    ...
    public mx.com.proyecti.Employee read(int id) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://proyecti.com.mx/", "read"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Integer(id)});
  ...
  throw axisFaultException;
    ...
    public mx.com.proyecti.Employee create(java.lang.String firstname, java.lang.String lastname, java.util.Calendar birthdate, double salary, java.lang.String username, java.lang.String password) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://proyecti.com.mx/", "create"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {firstname, lastname, birthdate, new java.lang.Double(salary), username, password});
  ...
  throw axisFaultException;
    ...
    public mx.com.proyecti.Employee[] readAll() throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://proyecti.com.mx/", "readAll"));
